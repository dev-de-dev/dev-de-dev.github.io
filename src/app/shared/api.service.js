(function () {
  ...
  angular.module('app.shared.service', [])
    .factory('ApiService', ['$http','$q','$state', function($http, $q, $state) {

      var baseUrl = '/v1/search/car';
      ...
      var params = {
        'apikey':'fzwxac3gtgsr35w7xpftr66k',
        'format':'json'};
      ...
      function getResults(config) {
        return $http.get(baseUrl, {
          ...
          var msg = 'An unexpected sever error happened. Please try again some time later. If the issue persists, contact our Hrlp Desk.';
